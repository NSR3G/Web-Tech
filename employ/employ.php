...
<head>
  ...
  <title>NSR EMPLOYEE</title>
  <link rel="stylesheet" type="text/css" href="../css1.css">
  <link rel="stylesheet" type="text/css" href="../css2.css">

</head>
<body style="background-image: url('../eimg2.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;">

<link rel="javascript" type="text/javascript" href="../js1.js">
<!-- Button to open the modal login form -->
<div>
<div class="imgcontainer" style="background-color:gray; color:gold;">
      <h1>NSR<br>EMPLOYEE</h1>
    </div>
<div class="bar">
<table width="100%">
<tr>
        <div  class="clearfix"> 
          <td> <button onclick="document.getElementById('id01').style.display='block'">Log In</button></td>
          <td> <button onclick="document.getElementById('id02').style.display='block'">Sign Up</button></td>
          <td><a href="../raghu/orders.php"> <button>orders</button></a></td>
          <td><a href="../raghu/servicerequests.php"><button>service requests</button></a></td>
		  <td><a href="../raghu/complaints.php"><button>complaints</button></a></td>
        </div>
...
<div id="id01" class="modal" >
  ...
  <form class="modal-content animate" action="../employ/eLogin.php" method="POST">
   <div class="container">
...
<div id="id02" class="modal"  >
  ...
  <form class="modal-content animate" onsubmit="return Validate()" action="../employ/esign.php" method = "POST">
    <div class="container">
      <h1>Sign Up</h1>
