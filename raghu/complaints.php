...
{if($rows['complain']!="" or $rows['complain']!=null){
...
?>
	...
	<td><?php echo $rows['complainid'];?></td>
...
<div id="id06" class="modal">
  <span onclick="document.getElementById('id06').style.display='none'" class="close" title="Close Modal">&times;</span>
   <form class="modal-content animate" action="status.php" method="POST">
    ...
    <label for="status">enter complaint status for :</label>
    ...
    <input type="text" name="status" /><br>
      <div class="clearfix" align="center">
        <button type="button" onclick="document.getElementById('id06').style.display='none'" class="cancelbtn">Cancel</button>
			<button type="submit" id="submit" class="signup">Submit</button>
